...
<?php include('navbar.php'); ?>
  ...
  <main role="main" class="container">
    ...
    <div class="row row-top">
        ...
        <div class="col-lg-12">
            <h1>Sistema Notificaciones Caja Jubilaciones</h1>
            <hr>

            <h2>Home</h2>
            <h3><font color='black'>ESTADO:</font> <font color='red'>DESARROLLO</font></h3>
                        </div>
      ...
      <div class="col-lg-12">
        <div class="card bg-light mb-12">
          <div class="card-header">
            <h3>Sistema de Gestion de Notificaciones Digitales</h3>
          </div>
